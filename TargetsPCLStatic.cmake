...
if(UNIX)
    add_library(pcl-common INTERFACE IMPORTED)
    set_property(TARGET pcl-common PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-common PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-common PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_COMMON_LIBRARY})

    add_library(pcl-octree INTERFACE IMPORTED)
    set_property(TARGET pcl-octree PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-octree PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-octree PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_OCTREE_LIBRARY})
...
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-io PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_IO_LIBRARY})

    add_library(pcl-kdtree INTERFACE IMPORTED)
    set_property(TARGET pcl-kdtree PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-kdtree PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-kdtree PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_KDTREE_LIBRARY})

    add_library(pcl-search INTERFACE IMPORTED)
    set_property(TARGET pcl-search PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-search PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-search PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_SEARCH_LIBRARY})
	
    add_library(pcl-sample-consensus INTERFACE IMPORTED)
    set_property(TARGET pcl-sample-consensus PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-sample-consensus PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-sample-consensus PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_SAMPLE_CONSENSUS_LIBRARY})

    add_library(pcl-filters INTERFACE IMPORTED)
    set_property(TARGET pcl-filters PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-filters PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-filters PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_FILTERS_LIBRARY})

    add_library(pcl-2d INTERFACE IMPORTED)
    set_property(TARGET pcl-2d PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-2d PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-2d PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_2D_LIBRARY})

    add_library(pcl-geometry INTERFACE IMPORTED)
    set_property(TARGET pcl-geometry PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-geometry PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    #set_property(TARGET pcl-geometry PROPERTY 
    #	INTERFACE_LINK_LIBRARIES ${PCL_GEOMETRY_LIBRARY})

    add_library(pcl-features INTERFACE IMPORTED)
    set_property(TARGET pcl-features PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-features PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-features PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_FEATURES_LIBRARY})

    add_library(pcl-ml INTERFACE IMPORTED)
    set_property(TARGET pcl-ml PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-ml PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-ml PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_ML_LIBRARY})

    add_library(pcl-segmentation INTERFACE IMPORTED)
    set_property(TARGET pcl-segmentation PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-segmentation PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-segmentation PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_SEGMENTATION_LIBRARY})

    add_library(pcl-visualization INTERFACE IMPORTED)
    set_property(TARGET pcl-visualization PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-visualization PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-visualization PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_VISUALIZATION_LIBRARY})

    add_library(pcl-surface INTERFACE IMPORTED)
    set_property(TARGET pcl-surface PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-surface PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-surface PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_SURFACE_LIBRARY})

    add_library(pcl-registration INTERFACE IMPORTED)
    set_property(TARGET pcl-registration PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-registration PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-registration PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_REGISTRATION_LIBRARY})

    add_library(pcl-keypoints INTERFACE IMPORTED)
    set_property(TARGET pcl-keypoints PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-keypoints PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-keypoints PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_KEYPOINTS_LIBRARY})

    add_library(pcl-tracking INTERFACE IMPORTED)
    set_property(TARGET pcl-tracking PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-tracking PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-tracking PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_TRACKING_LIBRARY})

    add_library(pcl-recognition INTERFACE IMPORTED)
    set_property(TARGET pcl-recognition PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-recognition PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-recognition PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_RECOGNITION_LIBRARY})

    add_library(pcl-stereo INTERFACE IMPORTED)
    set_property(TARGET pcl-stereo PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-stereo PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-stereo PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_STEREO_LIBRARY})

    add_library(pcl-outofcore INTERFACE IMPORTED)
    set_property(TARGET pcl-outofcore PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-outofcore PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-outofcore PROPERTY 
	    INTERFACE_LINK_LIBRARIES ${PCL_OUTOFCORE_LIBRARY})
	
    add_library(pcl-people INTERFACE IMPORTED)
    set_property(TARGET pcl-people PROPERTY
        INTERFACE_INCLUDE_DIRECTORIES ${PCL_INCLUDE_DIRS})
#    set_property(TARGET pcl-people PROPERTY
#	    INTERFACE_COMPILE_DEFINITIONS ${PCL_DEFINITIONS})
    set_property(TARGET pcl-outofcore PROPERTY 
        INTERFACE_LINK_LIBRARIES ${PCL_PEOPLE_LIBRARY})
